...
- **Bot files**: `/root/hk_bot/src/bot.py`, `/root/hk_bot/src/config_loader.py`, `/root/hk_bot/src/commands/woo_command.py`, `/root/hk_bot/src/commands/hkr_command.py`, `/root/hk_bot/src/commands/__init__.py`
